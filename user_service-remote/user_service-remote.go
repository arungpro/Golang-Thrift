...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "   get_users()")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := users.NewUserServiceClientFactory(trans, protocolFactory)
	...
	case "get_users":
		if flag.NArg()-1 != 0 {
			fmt.Fprintln(os.Stderr, "GetUsers requires 0 args")
			flag.Usage()
		}
		fmt.Print(client.GetUsers())
		fmt.Print("\n")
		break
	case "":
		Usage()
